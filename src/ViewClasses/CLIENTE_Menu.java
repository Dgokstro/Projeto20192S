...
public class CLIENTE_Menu extends JFrame {
	...
	public CLIENTE_Menu() {
		...
		lblCad_Cliente.setIcon(new ImageIcon(CLIENTE_Menu.class.getResource("/img/icon-cliente_menu_cadfunc_cinza.png")));
		...
		lblCad_Questionario.setIcon(new ImageIcon(CLIENTE_Menu.class.getResource("/img/icon-cliente_menu_cadquestionario_cinza.png")));
		...
		lblRelatorio.setIcon(new ImageIcon(CLIENTE_Menu.class.getResource("/img/icon-cliente_menu_relatorio_cinza.png")));
