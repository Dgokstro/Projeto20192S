...
public class CLIENTE_CadFunc extends JFrame {
	...
	public CLIENTE_CadFunc() {
		...
		lblCadFuncionario.setIcon(new ImageIcon(CLIENTE_CadFunc.class.getResource("/img/icon-cliente_menu_cadfunc_azul.png")));
		...
		lblQuestionario.setIcon(new ImageIcon(CLIENTE_CadFunc.class.getResource("/img/icon-cliente_menu_cadquestionario_cinza.png")));
		...
		lblRelatorio.setIcon(new ImageIcon(CLIENTE_CadFunc.class.getResource("/img/icon-cliente_menu_relatorio_cinza.png")));
