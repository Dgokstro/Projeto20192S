...
public class ViewCadFunc extends JFrame {
	...
	public ViewCadFunc() {
		...
		label.setIcon(new ImageIcon(ViewCadFunc.class.getResource("/img/logo-bitwise-reduzido.png")));
		...
		panel_1.add(label_2);
		label_2.setIcon(new ImageIcon(ViewCadFunc.class.getResource("/img/icon-cliente_menu_cadfunc_azul.png")));
...
//		txtDepartamento.setColumns(10);
		...
		lblCadFuncionario
				.setIcon(new ImageIcon(ViewCadFunc.class.getResource("/img/icon-cliente_menu_cadfunc_azul.png")));
		...
		lblRelatorio.setIcon(
				new ImageIcon(ViewCadFunc.class.getResource("/img/icon-cliente_menu_relatorio_cinza.png")));
		...
		lblSair.setIcon(new ImageIcon(ViewCadFunc.class.getResource("/img/iconsair.png")));
